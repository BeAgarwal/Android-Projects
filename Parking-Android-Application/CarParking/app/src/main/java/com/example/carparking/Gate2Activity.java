...
public class Gate2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = firebaseDatabase.getReference("Gate 2");
    ...
    private void confirmmessage(String x){
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                startActivity(new Intent(Gate2Activity.this, BookedActivity.class));
        ...
        builder.setNegativeButton("No", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                startActivity(new Intent(Gate2Activity.this, MainActivity.class));
            }
        });
        if(x.equals(""))
        {
    ...
    private void entrytodatabase(String name, String slot, String place){
        ...
        DatabaseReference myref2 = firebaseDatabase.getReference("Gate 2");
