...
public class CsItActivity extends AppCompatActivity {

    private TextView selection;
    private EditText etname;
    private Button A1, A2, A3, B1, B2, B3, C1, C2, C3, D1, D2, D3;
    private Button E1, E2, E3, F1, F2, F3, G1, G2, G3, book;
    private String result="";
    private String place = "CSIT";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cs_it);
        ...
        databaseReference = firebaseDatabase.getReference("CSIT");
    ...
    private void confirmmessage(String x){
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                startActivity(new Intent(CsItActivity.this, BookedActivity.class));
        ...
        builder.setNegativeButton("No", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                startActivity(new Intent(CsItActivity.this, MainActivity.class));
            }
        });
        if(x.equals(""))
        {
    ...
    private void entrytodatabase(String name, String slot, String place){
        ...
        DatabaseReference myref2 = firebaseDatabase.getReference("CSIT");
